...
ChatMainWindow::ChatMainWindow(const QString &nickname, QWidget *parent) : QMainWindow(parent)
{
  ...
  //  m_loginDialog = new LoginDialog(this);
    ...
    m_clientSocket = new ClientSocket(m_messageEdit, this);  // Pass a pointer to the message edit field as an argument
...
{
    // Get the message from the message edit field
    ...
    // Send the message through the client socket
    m_clientSocket->sendMessage(messageToSend);
